        ...
        {    
            ...
            if (result.length > 0)
            {
                ...
                for (let i = 0; i < result.length; i++) {
                    ...
                    <br>
                    <span style="font-weight: 500;">Asignaturas matriculadas: </span><span>${result[i].subjects.map((subject)=>` ${subject}`)}</span>
                    <br>
                    <br>
                    `
                }
                //con map, mapeamos todos los elementos del array y los ponemos uno detrás de otro.
                //se pide a map que devuelva ` ${subject}` para poder formatearlo con un espacio depue´s de cada coma.
            }
            else
    ...
    else
        {
            ...
            .then((result) =>{
                ...
                for (let i = 0; i < result.length; i++) {
                    ...
                    <span style="font-weight: 500;">Alumno: </span><span>${result[i].first_name} ${result[i].last_name}</span>
                    <br>
                    <span style="font-weight: 500;">Asignatura matriculada: </span><span>${result[i].subjects.map((subject)=>` ${subject}`)}</span>
                    <br>
                    <br>
                    `
                }
